...
export const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    metric: 'CLS',
    cause: 'The client strip renders without width and height and arrives late, so every row below it jumps.',
    effect: 'Cumulative Layout Shift rises far above 0.1 while load speed is untouched.',
