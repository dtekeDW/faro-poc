...
<template>
  <div class="pb-32 pt-28">
    <header class="px-6 md:px-10">
      <h1 class="fs-instrument text-3xl font-bold tracking-[-0.03em] md:text-4xl">
        Headline faces
      </h1>
      <p class="fs-instrument mt-3 max-w-[64ch] text-sm leading-relaxed text-mute">
      ...
      <div class="mt-8 flex flex-wrap items-center gap-3">
        <input
          ...
          class="fs-instrument min-w-0 flex-1 border-b border-chalk/20 bg-transparent pb-2 text-sm outline-none transition-colors focus:border-dodger"
        >
        <div class="flex gap-2">
          <button
            ...
            class="fs-instrument cursor-pointer rounded-full border border-chalk/20 px-4 py-1.5 text-xs transition-colors duration-300 hover:border-chalk/50 data-[active=true]:border-dodger data-[active=true]:bg-dodger data-[active=true]:text-ink"
            @click="filter = option"
          >
    ...
    <p class="fs-instrument mt-16 px-6 text-sm text-mute md:px-10">
